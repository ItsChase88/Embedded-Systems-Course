...
GPIO_PinConfig gpioPinConfigs[CONFIG_GPIO_COUNT] = {
    ...
    /* CONFIG_GPIO_SW_1 : LaunchPad Button USR_SW1 (Left) */
    GPIOMSP432E4_PJ0 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING,
    /* CONFIG_GPIO_SW_2 : LaunchPad Button USR_SW2 (Right) */
...
const uint_least8_t CONFIG_GPIO_SW_2_CONST = CONFIG_GPIO_SW_2;
